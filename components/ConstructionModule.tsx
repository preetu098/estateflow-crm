...
import { MOCK_CONSTRUCTION_LOGS } from '../constants';
...
const ConstructionModule: React.FC<ConstructionModuleProps> = ({ projects }) => {
  const [logs, setLogs] = useState<ConstructionUpdate[]>(MOCK_CONSTRUCTION_LOGS);
  ...
  const activeLogs = logs.filter(l => l.projectId === selectedProject);
